...
| Agent | File | Role |
|---|---|---|
| ScraperAgent | [SCRAPER.md](./agents/scraper/SCRAPER.md) | Extract structured data from the prospect's website |
| BrandAgent | [BRAND.md](./agents/brand/BRAND.md) | Derive palette, fonts, and copy from scraped data |
| DesignAgent | [DESIGN.md](./agents/design/DESIGN.md) | Review `docs/samples/`, produce layout spec JSON for CodegenAgent |
| CodegenAgent | [CODER.md](./agents/coder/CODER.md) | Generate JSX + CSS files from the design spec |
